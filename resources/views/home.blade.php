                    ...
                    <div class="card-body">
                        ...
                        <div class="uk-container uk-container-large uk-margin-top uk-width-1-1 ">
                            @if(Auth::check() && Auth::user()->type==0)
                                <a class="button button-primary button-large" style="margin-bottom: 10px" href="/freelancer/question">Tapti <br>laisvai <br>samdomu<br>specialistu<br><img style="width: 150px" src="img/Services.png"></a>&emsp;&emsp;
                            @endif
                        </div>
