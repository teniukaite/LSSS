...
<div id="about" class="uk-section uk-section-muted uk-section-large">
    <div class="uk-container">
        <div class="uk-width-4-5@m">
            <h4 class="uk-heading-small"><mark>Laisvai samdomų specialistų</mark> sąrašas</h4>
        </div>
...
{{--                                <img name="photo" class="uk-border-circle" alt="{{ $freelancer->name }}" src="{{ $freelancer->photo }}"readonly/>--}}
                        ...
                        @foreach($allCompetencies as $competencies)
                            @if ($freelancer->id == $competencies->freelancerID)
                        ...
                        <a href="/freelancer/{{ $freelancer->id }}/freelancerInfoView" class="uk-button uk-button-primary uk-button-large">Peržiūrėti</a>
